...
def build_parser() -> argparse.ArgumentParser:
    ...
    ap.add_argument("--diversity_fraction", default=0.30, type=float)
    ...
    ap.add_argument("--dedup_threshold", default=None, type=float)
    ap.add_argument("--dedup_threshold_mode", default="group_quantile", choices=["absolute", "group_quantile"])
    ap.add_argument("--dedup_quantile", default=0.15, type=float)
    ap.add_argument("--diversity_activation_mode", default="sample_stride", choices=["always", "sample_stride"])
    ap.add_argument("--diversity_min_sample_stride_seconds", default=5.0, type=float)
    ap.add_argument("--common_cache_dir", default="", type=str)
