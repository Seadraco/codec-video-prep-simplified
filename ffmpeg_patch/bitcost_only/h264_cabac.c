...
static int h264_cabac_stream_pos_bits(const CABACContext *c)
{
...
int ff_h264_decode_mb_cabac(const H264Context *h, H264SliceContext *sl)
{
    ...
    bits_before_mb = h264_cabac_stream_pos_bits(&sl->cabac);
    ...
    if (sl->slice_type_nos != AV_PICTURE_TYPE_I) {
        ...
        if( skip ) {
            ...
            {
                const int total_bits = h264_cabac_stream_pos_bits(&sl->cabac) - bits_before_mb;
