"""Installation diagnostics for compressed-video pre-infer."""
...
def check() -> list[tuple[str, bool, str]]:
    ...
    try:
        importlib.import_module("compressed_video_preinfer.cv_reader_fast")
    ...
    rows.append(("thread_type", cfg.thread_type == "frame", cfg.thread_type))
